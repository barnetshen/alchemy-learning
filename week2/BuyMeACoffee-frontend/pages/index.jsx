...
export default function Home() {
	...
	const contractAddress = '0xf55bba40ab88fd09Cf068aDaff4ec48f344534F8';
  ...
  const buyLargeCoffee = async () => {
	...
	return (
		<div className={styles.container}>
			<Head>
				<title>Buy Barnet a Coffee!</title>
				<meta name="description" content="Tipping site" />
				<link rel="icon" href="/favicon.ico" />
			</Head>

			<main className={styles.main}>
				<h1 className={styles.title}>Buy Barnet a Coffee!</h1>
				...
				{currentAccount ? (
					<div>
						<form>
							...
							<br />
							<div>
								<label>Send Barnet a message</label>
								<br />
